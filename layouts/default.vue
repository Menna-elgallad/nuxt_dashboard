...
<div id="allTheNav" style="display:flex">
  ...
  <div  class="sidenavopen" style="display:flex" >
   ...
   <div class="nav1">
    <ul>
      <li >
     <nuxt-link to="/" >  
    <img src="@/assets/img/tatmeen_logo.svg" alt="" style="width:20px;display: block; margin: auto">
      ...
      <li >
        ...
        <nuxt-link to="/" >  
           <i class="pi pi-home "></i></nuxt-link>
      </li>
      <li  @click="opendside('1')">
        <nuxt-link ><i class="pi pi-fw pi-user"></i></nuxt-link>
      </li>
      <li @click="opendside('2') ">
        <nuxt-link >
   ...
   <div class="nav2" v-if="opened">
    <div style="display:flex ; align-items:center ; justify-content: space-between;">
    <img src="@/assets/img/tatmeen.svg" alt="" style="color: #a6d5fa;width:130px;display: block; margin-top: 7px;">
    <i class="pi pi-times-circle " style="cursor: pointer;" @click="closeside()"></i>
      </div>
    <ul style="margin-top:20px">
    
      <li v-for="item in selected" :key="item.key" >
        <i :class="item.icon +' mr-2 myicon'" ></i>
